...
bool parseInputParameters(int ac, char *av[], std::string &runCommand) {
    ...
    try {
        ...
        desc.add_options()("help,h",
                           "runTests - run tests using sbruntests script.")(
            ...
            "farm,f", po::value<std::string>(),
            "This parameter will be decided based on the location of current "
        ...
        runCommand = Tools::getSbruntestsCommand(Tools::getFarmOption(farm, sandbox), listFile, runFolder);
